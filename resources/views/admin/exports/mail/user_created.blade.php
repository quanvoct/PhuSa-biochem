...
<body>
    <span class="preheader">Thông báo tạo tài khoản mới</span>
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <ul>
                                                <li>Tên đăng nhập: {{ $data['user']->email }}</li>
                                                <li>Mật khẩu: {{ $data['password'] }}</li>
                                            </ul>
                                            </p>
                                            <p>LƯU Ý: Vui lòng đổi mật khẩu ngay sau lần đăng nhập đầu tiên để bảo mật tốt hơn.</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
