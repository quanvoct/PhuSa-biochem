                            ...
                            <div class="ltn__product-tab-content-inner ltn__product-grid-view">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="{{ route('shop.index') }}">Master mix 2X SyBr Green</a></h2>
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="{{ route('shop.index') }}">Loading Buffer 6X</a></h2>
                                                <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{ route('shop.index') }}"><img src="{{ asset('img/product/product-demo-8.jpg') }}" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                                    </ul>
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{ route('shop.index') }}"><img src="{{ asset('img/product/product-demo-9.jpg') }}" alt="#"></a>
                                                <div class="product-hover-action">
                                                    <ul>
                                                        <li>
                                                            <a href="#" title="Quick View" data-bs-toggle="modal" data-bs-target="#quick_view_modal">
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{ route('shop.index') }}"><img src="{{ asset('img/product/product-demo-11.jpg') }}" alt="#"></a>
                                                <div class="product-hover-action">
                                                    <ul>
                                                        <li>
                                                            <a href="#" title="Quick View" data-bs-toggle="modal" data-bs-target="#quick_view_modal">
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="{{ route('shop.index') }}">Vertical electrophoresis machine VE100</a></h2>
                                                <div class="product-price">
