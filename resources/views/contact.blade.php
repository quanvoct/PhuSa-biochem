...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="ltn__form-box contact-form-box box-shadow white-bg">
                        ...
                        <form id="contact-form" action="mail.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-item input-item-name ltn__custom-icon">
                                        <input name="name" type="text" placeholder="{{ __('Enter your name') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item input-item-email ltn__custom-icon">
                                        <input name="email" type="email" placeholder="{{ __('Enter email address') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item input-item-subject ltn__custom-icon">
                                        <input name="subject" type="text" placeholder="{{ __('Enter the subject') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item input-item-phone ltn__custom-icon">
                                        <input name="phone" type="text" placeholder="{{ __('Enter phone number') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <p><label class="input-info-save mb-0"><input name="agree" type="checkbox"> {{ __('Save my name, email, and website in this browser for the next time I comment.') }}</label>
                            </p>
    ...
    <div class="google-map mb-120">
        @if (isset(session('settings')['contact_map']))
