                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="ltn__product-item ltn__product-item-3">
                                        <div class="product-img">
                                            <a href="{{ route('shop.index', ['catalogue' => $product->catalogues->first()->slug, 'product' => $product->slug]) }}"><img src="{{ $product->getImageUrlAttribute() }}" alt="img"></a>
                                        </div>
                                        <div class="product-info">
                                            <h2 class="product-title"><a href="{{ route('shop.index', ['catalogue' => $product->catalogues->first()->slug, 'product' => $product->slug]) }}">{!! $product->name !!}</a></h2>
                ...
                <div class="ltn__pagination-area text-center">
                    <div class="ltn__pagination">
                        <ul>
                            ...
                            @for ($page = $startPage; $page <= $endPage; $page++) @if ($page==$currentPage) <li class="active"><a href="{{ $products->url($page) }}">{{ $page }}</a></li>
                                @else
                                ...
                                @if ($endPage < $totalPages) @if ($endPage < $totalPages - 1) <li class="disabled"><span>...</span></li>
                                    @endif
