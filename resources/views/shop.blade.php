                                        ...
                                        @foreach ($products as $product)
                                            ...
                                            <div class="col-lg-12">
                                                <div class="ltn__product-item ltn__product-item-3">
                                                    <div class="product-img">
                                                        <a href="{{ route('shop.index', ['catalogue' => $product->catalogues->first()->slug, 'product' => $product->slug]) }}"><img src="{{ $product->imageUrl }}" alt="img"></a>
                                                    </div>
                                                    <div class="product-info">
                        ...
                        <!-- <div class="widget ltn__price-filter-widget">
                                ...
                                <div class="price_filter">
                                    <div class="price_slider_amount">
                                        ...
                                        <input class="amount" name="price" type="text" placeholder="Add Your Price"/>
                                    </div>
