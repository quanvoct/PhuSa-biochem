                            ...
                            <div class="ltn__product-tab-content-inner ltn__product-grid-view">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="{{ route('home.product') }}">Master mix 2X SyBr Green</a></h2>
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="{{ route('home.product') }}">Loading Buffer 6X</a></h2>
                                                <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{ route('home.product') }}"><img src="{{ asset('img/product/product-demo-8.jpg') }}" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                                    </ul>
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{ route('home.product') }}"><img src="{{ asset('img/product/product-demo-9.jpg') }}" alt="#"></a>
                                                <div class="product-hover-action">
                                                    <ul>
                                                        <li>
                                                            <a href="#" title="Quick View" data-bs-toggle="modal" data-bs-target="#quick_view_modal">
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{ route('home.product') }}"><img src="{{ asset('img/product/product-demo-11.jpg') }}" alt="#"></a>
                                                <div class="product-hover-action">
                                                    <ul>
                                                        <li>
                                                            <a href="#" title="Quick View" data-bs-toggle="modal" data-bs-target="#quick_view_modal">
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="{{ route('home.product') }}">Vertical electrophoresis machine VE100</a></h2>
                                                <div class="product-price">
                ...
                <div class="col-lg-4">
                    <aside class="sidebar ltn__shop-sidebar ltn__right-sidebar sticky-top">
                        ...
                        <div class="widget ltn__menu-widget">
                            ...
                            <ul>
                                <li><a href="{{ route('home.shop') }}">All Product <span><i class="fas fa-long-arrow-alt-right"></i></span></a></li>
                                <li><a href="{{ route('home.shop') }}">Oligo/Primer  <span><i class="fas fa-long-arrow-alt-right"></i></span></a></li>
                                <li><a href="{{ route('home.shop') }}">Biology Products <span><i class="fas fa-long-arrow-alt-right"></i></span></a></li>
                                <li><a href="{{ route('home.shop') }}">Device <span><i class="fas fa-long-arrow-alt-right"></i></span></a></li>
                                <li><a href="{{ route('home.shop') }}">Utility package <span><i class="fas fa-long-arrow-alt-right"></i></span></a></li>
                                <li><a href="{{ route('home.shop') }}">Services <span><i class="fas fa-long-arrow-alt-right"></i></span></a></li>
                                <li><a href="{{ route('home.shop') }}">Diagnostic kit <span><i class="fas fa-long-arrow-alt-right"></i></span></a></li>
                            </ul>
                        </div>
                        <!-- Price Filter Widget -->
