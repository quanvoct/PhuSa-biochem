            ...
            <div class="row">
                ...
                <div class="col-lg-7 align-self-center">
                    <div class="about-us-info-wrap">
                        ...
                        <div class="btn-wrapper animated">
                            <a class="ltn__secondary-color text-uppercase text-decoration-underline" href="{{ route('home.index', ['page' => 'about']) }}">{{ __('Read more') }}</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row ltn__category-slider-active-six slick-arrow-1">
                <div class="col-12">
                    <div class="ltn__brand-logo-item">
                        <a data-rel="lightcase:myCollection" href="{{ asset('img/partners/logo_clrri.png') }}"></a>
                ...
                <div class="col-12">
                    <div class="ltn__brand-logo-item">
                        <a data-rel="lightcase:myCollection" href="{{ asset('img/partners/logo_ctu.png') }}">
                ...
                <div class="col-12">
                    <div class="ltn__brand-logo-item">
                        <a data-rel="lightcase:myCollection" href="{{ asset('img/partners/logo_ctump.png') }}">
                ...
                <div class="col-12">
                    <div class="ltn__brand-logo-item">
                        <a data-rel="lightcase:myCollection" href="{{ asset('img/partners/logo_eurogentec.png') }}">
                ...
                <div class="col-12">
                    <div class="ltn__brand-logo-item">
                        <a data-rel="lightcase:myCollection" href="{{ asset('img/partners/logo_khtn.png') }}">
                ...
                <div class="col-12">
                    <div class="ltn__brand-logo-item">
                        <a data-rel="lightcase:myCollection" href="{{ asset('img/partners/logo_millipore_sigma.png') }}">
                ...
                <div class="col-12">
                    <div class="ltn__brand-logo-item">
                        <a data-rel="lightcase:myCollection" href="{{ asset('img/partners/logo_t4oligo.png') }}">
                ...
                <div class="col-12">
                    <div class="ltn__brand-logo-item">
                        <a data-rel="lightcase:myCollection" href="{{ asset('img/partners/logo_utah.png') }}">
                ...
                <div class="col-12">
                    <div class="ltn__brand-logo-item">
                        <a data-rel="lightcase:myCollection" href="{{ asset('img/partners/logo_vienhanlam.png') }}">
                ...
                <div class="col-12">
                    <div class="ltn__brand-logo-item">
                        <a data-rel="lightcase:myCollection" href="{{ asset('img/partners/logo_yale.png') }}">
